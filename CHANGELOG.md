...
- d1451a0: Close the fingerprint gaps found in large monorepos. The hash algorithm is unchanged; the _file set_ it covers is now correct in four more situations:
